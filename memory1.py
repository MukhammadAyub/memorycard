...
AnsGroupBox = QGroupBox('Результаn теста')
lb_result = QLabel()
lb_correct = QLabel()
...
def check_answer():
    if answers[0].isChecked():
        ...
        main_win.score += 1
        print('Статисктика:\n Всего вопросов задано:', main_win.total, '\Верных ответов:', main_win.score)
...
q = Question('В каком году родился Аль-Хорезми?', '783', '971', '865', '1995')
